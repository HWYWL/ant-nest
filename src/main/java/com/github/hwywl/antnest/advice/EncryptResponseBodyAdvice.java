...
import com.github.hwywl.antnest.annotation.encrypt.*;
...
import com.github.hwywl.antnest.utils.*;
 ...
 * 以及package为<strong><code>com.github.hwywl.antnest.annotation.encrypt.*</code></strong>下的注解有效
 *
 * @author YI
 * @version 2019年6月16日
...
public class EncryptResponseBodyAdvice implements ResponseBodyAdvice {
    ...
    public boolean supports(MethodParameter returnType, Class converterType) {
        ...
        return returnType.getMethod().isAnnotationPresent(AESEncryptBody.class) ||
    ...
    private String switchEncrypt(String formatStringBody, EncryptAnnotationInfoBean infoBean) {
        ...
        if (method == EncryptBodyMethod.DES) {
            ...
            return des.encryptHex(formatStringBody);
        }
        if (method == EncryptBodyMethod.AES) {
            ...
            return aes.encryptHex(formatStringBody);
        }
        throw new EncryptBodyFailException();
    }
